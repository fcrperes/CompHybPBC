...
cx q_stab[2],q_stab[4];
measure q_stab[4] -> c_stab[2];
if(c_stab[2]==1) s q_stab[2];
cx q_stab[1],q_stab[2];
cx q_stab[2],q_stab[5];
measure q_stab[5] -> c_stab[3];
if(c_stab[3]==1) s q_stab[2];
s q_stab[2];
s q_stab[2];
s q_stab[2];
cx q_stab[0],q_stab[2];
...
cx q_stab[1],q_magic[2];
measure q_magic[2] -> c_magic[2];
if(c_magic[2]==1) s q_stab[1];
s q_stab[1];
s q_stab[1];
s q_stab[1];
